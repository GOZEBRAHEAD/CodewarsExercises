...
public class Kata {
  public static int lostSheeps(int[] fridayNightCounting, 
                               int[] saturdayNightCounting, 
                               int sheepsTotal) {
    
    int auxTotalFriday = 0;
    int auxTotalSaturday = 0;
    
    for (int sheepAmount : fridayNightCounting) {
      auxTotalFriday += sheepAmount;
    }
    
    for (int sheepAmount : saturdayNightCounting) {
      auxTotalSaturday += sheepAmount;
    }
    
    return (sheepsTotal - auxTotalFriday - auxTotalSaturday);
  }
}
